...
export default function OnboardingPage() {
  ...
  const { form, selecciones, estadoFiscal, loading, error, fakeSuccess, setForm, setEstadoFiscal, toggleSubrubro, puedeAvanzar, guardarYFinalizar, handleRegistro } = useOnboardingForm()
  ...
  return (
    <>
      ...
      {pasoNum === 4 && <Step4Registro isMobile={isMobile} onRegistrar={handleRegistro} loading={loading} error={error} fakeSuccess={fakeSuccess} email={form.email} />}
