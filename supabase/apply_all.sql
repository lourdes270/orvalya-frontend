-- Orvalya: aplicar TODO de una vez en Supabase SQL Editor
-- Si ya corriste la parte 001, usá apply_all_002_fix.sql en su lugar.
...
-- ═══ 002: documentos versionado (compatible con enum estado_documento) ═══

-- Valores actuales del enum: SELECT enum_range(NULL::estado_documento);
...
-- Solo valores que existen en el enum (pendiente sí; aprobado NO)
UPDATE public.documentos
...
-- No agregar CHECK en estado: ya está restringido por el enum
